       ...
       and put them into the xls work sheet */
        ...
        Get all addressbook entries from  $dn
         and put them into the xls work sheet */
                ...
                $address = $ldap->gen_xls(
                    $dn,
                    "(objectClass=*)",
                    array(
                        "cn", "displayName", "facsimileTelephoneNumber", "givenName",
                ...
                $intitul =  array(
                    _("Common name") . ":", _("Display name") . ":", _("Fax") . ":",
        ...
        $address = $ldap->gen_xls(
            ...
            "(objectClass=*)",
            array(
                "cn", "displayName", "facsimileTelephoneNumber", "givenName", "homePhone", "homePostalAddress",
        ...
        $address_intitul =
            array(
                "cn", _("Display name") . ":", _("Fax") . ":", _("Surname") . "/" . _("Given name") . ":",
